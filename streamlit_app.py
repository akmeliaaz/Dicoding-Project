...
#read file csv
url = 'https://raw.githubusercontent.com/akmeliaaz/Dicoding-Project/refs/heads/main/day.csv'
link = 'https://raw.githubusercontent.com/akmeliaaz/Dicoding-Project/refs/heads/main/hour.csv'
df_day = pd.read_csv(url, index_col="instant", parse_dates=["dteday"])
df_hour = pd.read_csv(link, index_col="instant", parse_dates=["dteday"])
